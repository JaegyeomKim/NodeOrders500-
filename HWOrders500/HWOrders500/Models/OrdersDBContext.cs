...
namespace HWOrders500.Models
{
    public partial class OrdersDBContext : DbContext
    {
        ...
        public virtual DbSet<SalesPersonKey> SalesPersonKeys { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalesPersonKey>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("SalesPersonKeys$");
